...
use EasyCorp\Bundle\EasyAdminBundle\Controller\AbstractDashboardController; // AdminUrlGenerator
use EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator; // AdminUrlGenerator
